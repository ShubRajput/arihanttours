import { MapPin, Globe, Shield, Star, Sparkles, Award, Users, TrendingUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Explore 500+ destinations across 6 continents with expert guidance',
    },
    {
      icon: Shield,
      title: 'Safe & Secure',
      description: 'Travel with confidence knowing you are fully insured and protected',
    },
    {
      icon: Star,
      title: 'Premium Experience',
      description: 'Hand-picked hotels, exclusive tours, and unforgettable experiences',
    },
    {
      icon: Award,
      title: 'Award Winning',
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed">
              Discover extraordinary destinations, create unforgettable memories, and experience the world like never before
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We provide exceptional service and unforgettable experiences for every traveler
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-orange-100 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-orange-600 text-sm font-semibold">POPULAR TOURS</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                    <span className="text-sm font-semibold text-orange-600">{destination.duration}</span>
                  </div>
                </div>
                <div className="p-6">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-200 mb-10 max-w-2xl mx-auto">
            Let us help you create memories that will last a lifetime. Contact us today and begin your journey!
          </p>
